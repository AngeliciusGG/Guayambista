    ...
    <header>
        ...
        <div>
            <div class="logo-titulo-subtitulo">
                <div>
                    <img src="Imagenes/Logos/Logo black-bakcground.jpg" class="logo-header">
        ...
        <section id="seccion-principal">
            <div class="presentacion">
                ...
                <div class="qr-mapas-descargable">
                    <div>
                        <h3 class="titulo-qr">📱 QR de la Página</h3>
                        <div>
                            <img class="codigo-qr" src="" alt="">
                        </div>
                        <p class="parrafo-qr">Escanea para acceder desde tu móvil</p>
                    </div>
                    <div class="mapa-guayamba">
                        <div class="pdf-mapa">
                            <h3 class="titulo-mapa">🗺️ Mapa descargable</h3>
                        ...
                        <div class="referencias-mapa">
                            <h4 class="referencia-mapa">Referencias del mapa descargable</h4>
                            <div class="texto-referencia-mapa">
                                <p>Referencia 1:punto de señal </p>
                                <p>Referencia 2:kiosco</p>
                                <p>Referencia 3:hospedaje/ camping</p>
                                <p>Referencia 4:posta/ Hospital</p>
                                <p>Referencia 5:comisaria</p>
                                <p>Referencia 6:Municipalidad</p>
                                <!-- <p>Referencia 1</p> -->
                ...
                <div class="division-de-zonas">
                    ...
                    <!-- estrcutura del contendedor de referencias
                     ...
                     <div class="contenedor-de-descripcion">
                                ...
                                <p class="texto-referencia"></p>
                                <img src="" class="img-referencia">
                            ...
                            -->
                    <div class="contenedor-referencia-de-zonas">
                        ...
                        <div class="referencia">
                            ...
                            <div class="contenedor-de-descripcion">
                                ...
                                <img class="img-referencia"
                                    src="Imagenes/Plaza-complejo-rio-guayamba/Río Guayamba, vista desde la pasarela hacia el río.jpg">
                            </div>
                    ...
                    <div class="contenedor-referencia-de-zonas">
                        ...
                        <div class="referencia">
                            ...
                            <div class="contenedor-de-descripcion">
                                ...
                                <p class="texto-referencia">Campings Los Abuelos</p>

                                <img src="Imagenes/hospedajes,campings/Camping Los Abuelos.jpg" class="img-referencia">
                            ...
                            <div class="contenedor-de-descripcion">
                                ...
                                <p class="texto-referencia">Camping los Marucos</p>
                                <img src="Imagenes/hospedajes,campings/Camping Marucos.jpg" class="img-referencia">
                    ...
                    <div class="contenedor-referencia-de-zonas">
                        ...
                        <div class="referencia">
                            ...
                            <div class="contenedor-de-descripcion">
                                ...
                                <p class="texto-referencia">Hospital El Alto</p>
                                <img src="Imagenes/Salud-y-seguridad/Hospital El Alto.jpg" class="img-referencia">
                            ...
                            <div class="contenedor-de-descripcion">
                                ...
                                <img src="Imagenes/Salud-y-seguridad/Comisaría Guayamba.jpg" class="img-referencia">

                            </div>
                            <div class="contenedor-de-descripcion">

                                <p class="texto-referencia">Municipalidad Guayamba</p>
                                <img src="Imagenes/Salud-y-seguridad/Municipalidad Guayamba.jpg" class="img-referencia">

                            </div>
                            <div class="contenedor-de-descripcion">

                                <p class="texto-referencia">Posta Sanitaria Guayamba</p>
                                <img src="Imagenes/Salud-y-seguridad/Posta Guayamba.jpg" class="img-referencia">
                    ...
                    <div class="contenedor-referencia-de-zonas">
                        ...
                        <div class="referencia">
                            ...
                            <div class="contenedor-de-descripcion">
                                ...
                                <img src="Imagenes/Estación-de-servicio/Estación de servicio.jpg"
                                    class="img-referencia">
                            </div>
                    ...
                    <div class="contenedor-referencia-de-zonas">
                        ...
                        <div class="referencia">
                            ...
                            <div class="contenedor-de-descripcion">
                                ...
                                <img src="Imagenes/Plaza-complejo-rio-guayamba/Plaza Guayamba.jpg"
                                    class="img-referencia">

                            </div>
                            <div class="contenedor-de-descripcion">
                                <p class="texto-referencia">Complejo Recreativo Guayamba</p>
                                <img src="Imagenes/Plaza-complejo-rio-guayamba/Complejo Recreativo Guayamba.jpg" alt=""
                                    class="img-referencia">
    ...
    <footer>
        <div>
            <div class="info_footer">
                <img src="Imagenes/Logos/logo white-bakcground.jpg" class="img_footer">
